...
struct hashmap {
    ...
    uint64_t (*hash)(void *item, uint64_t seed0, uint64_t seed1);

    int (*compare)(void *a, void *b, void *udata);
...
uint64_t hashmap_sip(void *data, size_t len,
                     uint64_t seed0, uint64_t seed1);
